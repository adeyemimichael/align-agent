...
"[project]/align/app/api/checkin/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const checkInSchema = __TURBOPACK__imported__module__$5b$project$5d2f$align$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].object({
    energy: __TURBOPACK__imported__module__$5b$project$5d2f$align$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().int().min(1).max(10),
    sleep: __TURBOPACK__imported__module__$5b$project$5d2f$align$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().int().min(1).max(10),
    stress: __TURBOPACK__imported__module__$5b$project$5d2f$align$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].number().int().min(1).max(10),
    mood: __TURBOPACK__imported__module__$5b$project$5d2f$align$2f$node_modules$2f$zod$2f$v4$2f$classic$2f$external$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__z$3e$__["z"].enum([
        'positive',
        'neutral',
        'negative'
    ])
...
function calculateCapacityScore(energy, sleep, stress, mood) {
    ...
    const score = normalizedEnergy * energyWeight + normalizedSleep * sleepWeight + (1 - normalizedStress) * stressWeight + moodModifier * moodWeight;
    // Scale to 0-100
    return Math.round(score * 100);
}
// Mode selection function
function selectMode(capacityScore) {
...
async function POST(request) {
    try {
        ...
        const checkIn = await __TURBOPACK__imported__module__$5b$project$5d2f$align$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].checkIn.upsert({
            where: {
                userId_date: {
                    userId: user.id,
                    date: today
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$align$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(checkIn, {
            status: 200
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2b84c86c._.js.map